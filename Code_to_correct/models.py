...
class Cnn14(nn.Module):
    def __init__(self, pretrained_weights_path=None, ):#sample_rate, window_size, hop_size, mel_bins, fmin, fmax, classes_num
    ...
    def forward(self, input, mixup_lambda=None):
        ...
        # WALE:The STFT used in this code does not support multi-channel, you need to change it manually
        B, C, T = input.shape
        ...
        # WALE: Be very careful about the output of the model. It output a dict instead of a tensor
