...
class FeatureClass:
    def __init__(self, params, is_eval= False):    #False
        """
        ...
        self._dataset_combination = '{}_{}'.format(params['dataset'], 'eval' if is_eval else 'dev')# check
...
#            pool.join()
    ...
    def extract_all_labels(self):
        ...
        if self._label_dir is None: return  # WALE's ADDITION
