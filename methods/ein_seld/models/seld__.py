...
class EINV2(nn.Module):
    ...
    def load_from_pretrain(self, pretrained_checkpoint_path):
        checkpoint = torch.load(pretrained_checkpoint_path) # pretrained_checkpoint_path
        self.base.load_state_dict(checkpoint['/mnt/raid/ni/WALE_SEdl/EIN-SELD/Cnn14_DecisionLevelMax_mAP=0.385.pth']) #model
