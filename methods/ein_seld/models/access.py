...
class Transfer_Cnn14(nn.Module):
    def __init__(self, in_channels_sed,in_channels_doa, classes_num, freeze_base, 
                ): # sample_rate, window_size, hop_size, mel_bins, fmin, fmax
    ...
    def load_from_pretrain(self, pretrained_checkpoint_path):
        checkpoint = torch.load('/mnt/raid/ni/WALE_SEld/EIN-SELD/')# pretrained_checkpoint_path
